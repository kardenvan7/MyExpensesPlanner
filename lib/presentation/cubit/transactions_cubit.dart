...
import 'package:my_expenses_planner/domain/core/extensions/datetime_extensions.dart';
import 'package:my_expenses_planner/domain/models/transaction.dart';
import 'package:my_expenses_planner/domain/use_cases/transactions/i_transactions_case.dart';

class TransactionsCubit extends Cubit<TransactionsState> {
  TransactionsCubit({required this.transactionsCaseImpl})
      : super(
          TransactionsState(
  ...
  final ITransactionsCase transactionsCaseImpl;
  ...
  Future<void> fetchLastTransactions() async {
    _transactions.clear();
    _transactions.addAll(await transactionsCaseImpl.getLastTransactions());
  ...
  Future<void> addTransaction(Transaction transaction) async {
    await transactionsCaseImpl.save(transaction: transaction);
  ...
  Future<void> editTransaction({
    ...
    await transactionsCaseImpl.edit(
      transactionId: txId,
  ...
  Future<void> deleteTransaction(String txId) async {
    transactionsCaseImpl.delete(transactionId: txId);
